            ...
            <div className="hero h-[650px] w-4/5 mx-auto" style={{ backgroundImage: 'url(https://i.ibb.co/Fmq46Nh/pexels-binyamin-mellish-116077.jpg)' }}>
               ...
               <div className="lg:flex lg:gap-x-96"> <div className="hero-content text-center text-neutral-content">
                    <div className="max-w-md">
                        <h1 className="mb-8 text-5xl font-bold text-amber-500 italic">HARD </h1>
                        <p className="mb-5 text-2xl font-bold">Gym Fitness</p>
                ...
                <div className="hero-content text-center text-neutral-content">
                    <div className="max-w-md">
                        <h1 className="mb-8 text-5xl font-bold text-amber-500 italic">&FIT</h1>
                        <p className="mb-5 text-3xl font-bold">Shape<br></br><span className="italic text-green-700">Your</span><span className="text-yellow-200">Body</span></p>
